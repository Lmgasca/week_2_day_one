...
# put age and number in a sentence
print("Their age is" + str(age) + "and their favorite number is" + number + ".")
date_of_birth = 2011
number2 = 123
number3 = 123.456
number4 = 123.33
number5 = 4555
print("The year you born is" + str(date_of_birth) + ", the amount of pets you have is" + str(number2) + ", the amount of pennies you have is" + str(number3) + ", the amount of money you have in your bank account is" + str(number4) + "and your 21st birthday is in the following amount of days" + str(number5))
#create a sentence of all this above
print(f"the date of brith is {date_of_birth} and the number is {number2} and the number is {number3} and the number is {number4} and the number is {number5}")

# [name] liked to hum the song [song] while coding. It was so annoying that their teammates would throw [food] until [name] would stop singing.
print(f"{name} liked to hum the song {song} while coding. It was so annoting that their teamates would throw {food} until {name} would stop singing")
...
# variable_name
# Zero
# list # this is a keywords in python
